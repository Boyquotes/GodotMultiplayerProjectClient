...
func _ready() -> void:
	...
	owner.connect("idle_signal", transition_to_idle)
	owner.connect("walk_signal", transition_to_walk)
	owner.connect("walkto_signal", transition_to_walktotarget)
...
func transition_to_walktotarget():
